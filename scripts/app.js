...
function quizBank(response){
    ...
    allQuestions.forEach((question, index)=>{
      ...
      <div class="flex flex-col items-start justify-start gap-2">
        <div id="optionA" class="Q${index+1} flex items-center gap-4">
        ...
        <div id="optionB" class="Q${index+1} flex items-center gap-4">
        ...
        <div id="optionC" class="Q${index+1} flex items-center gap-4">
        ...
        <div id="optionD" class="Q${index+1} flex items-center gap-4">
...
function quizManager(){
    ...
    allOptions.forEach((option)=>{
        option.addEventListener('click', ()=>{
            console.log(option.parentElement.id)
            console.log(option.parentElement.classList[0])
